...
function updateGaugeToken(
  ...
  log.info("apr1 {} {} {} {} {} {}",[now.toHexString(), finishPeriod.toHexString(), leftETH.toString(), totalSupplyETH.toString(),pairPriceETH.toString(),gauge.totalDerivedSupply.toString()])
